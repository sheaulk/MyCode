package testCases;
import resources.testCases.SmokeTestHelper;
import tasks.Common;
import tasks.GPE;
import tasks.SAP;
import tasks.SCR;
 ...
 * @author sheaulk
 */
public class SmokeTest extends SmokeTestHelper
{
	/**
	...
	//		while(!bidsummary.get_bidSummary().exists()) gpe.dismissUnexpectedWindow();
				...
				gpe.initiateSQA();
				gpe.verify1014(itemrollup.get_quoteItemRollupGrid(), 1, "Total Adjusted Price", "YP00");
				unregisterAll();
